...
the_matrix = media.Movie("The Matrix", 1999, "Neo discovers he is living in a computer simulation",
...
# Display them in a browser window (in a page generated from fresh_tomatoes.py)
